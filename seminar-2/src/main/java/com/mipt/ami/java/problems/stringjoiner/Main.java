package com.mipt.ami.java.problems.stringjoiner;

import java.util.concurrent.TimeUnit;

public class Main {

    private static final String TEXT_1 = "Moscow";
    private static final String TEXT_2 = "Institute";
    private static final String TEXT_3 = "of";
    private static final String TEXT_4 = "Physics";
    private static final String TEXT_5 = "Technology";
