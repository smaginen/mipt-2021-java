package com.mipt.ami.java.task.stream.groupingby;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.Collection;

import static com.mipt.ami.java.task.stream.groupingby.Melon.Sugar.HIGH;
import static com.mipt.ami.java.task.stream.groupingby.Melon.Sugar.LOW;
import static com.mipt.ami.java.task.stream.groupingby.Melon.Sugar.MEDIUM;
